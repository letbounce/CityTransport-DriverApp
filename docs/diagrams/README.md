...
- Заливка фігур (класи UML): світло-кремова `#fdf6e3`, заголовок `#f5e8c8`, бордер `#b89a5c`
- Заливка фігур (sequence — серверні): світло-блакитна `#dfeaf7`; клієнтські — кремові `#fdf6e3`
- Заливка фігур (ER-сутності): світло-блакитна `#eef3f9`, заголовок `#dfeaf7`, бордер `#5a6b8a`
- Embedded sub-documents (для MongoDB): світло-зелена `#f0f6ec`, бордер `#7a9a7a`
...
| 11 | _чекає_ | Організаційна структура диспетчерської служби АТП | 1.1 | TODO |
| 12 | _чекає_ | Діаграма діяльності (Activity) — паралельні процеси | 2.3 | TODO |
| 13 | _чекає_ | Діаграма трасування вимог | 2.3 | TODO |
| 14 | _чекає_ | Схема алгоритму обробки інциденту (ДСТУ 19.701-90) | 2.2.2 | TODO |
